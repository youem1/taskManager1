...
const UserPage=()=>{
    ...
    const [conten,setContent]=useState(<ProjectList projects={getProjectInfo} refresh={need_refresh} createProject={()=>{}}/>);
    ...
    if(refresh){
        switch(mystore1.page){
            ...
            case 'project':
                setContent( <ProjectList projects={getProjectInfo} refresh={need_refresh} createProject={()=>{}}/>);
